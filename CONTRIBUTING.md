...
> AgentGuard is an independent repository. Issues and feature requests live on the [issue tracker](https://github.com/Abdellox/AgentGuard/issues) — use the provided templates.
